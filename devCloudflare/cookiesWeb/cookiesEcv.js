  ...
  <div class="content-wrap">
      <div class="msg-wrap" >
          <p> Ecuavisa utiliza cookies propias y de terceros para fines analíticos anónimos, guardar las preferencias que selecciones y para el funcionamiento general de la página.
              <br><br>Puedes aceptar todas las cookies pulsando el botón "Aceptar" o configurarlas o rechazar su uso pulsando el botón "Configurar" v2 - ${window.NativeFunction} ${navigator.userAgent}.<br>
