...
import { useTheme } from 'vuetify';
  ...
  // Función de carga y descarga individual
...
watch(() => props.dateRange, () => {
  if (props.dataCampaigns && props.dataCampaigns.length > 0) {
    cargarDatosCampaña()
  }
}, { deep: true })
...
<template>
			...
			<VCol class="mt-0" cols="12" md="12" lg="12" >
              ...
              <div class="d-flex pr-0" style="justify-content: space-between;">
                <div class="descripcion">
                  ...
                  <VCardSubtitle>*Mostrando data desde, {{dateRange.start}} hasta {{dateRange.end}}</VCardSubtitle>
    ...
    <div style="min-width: 230px;width: auto;">
      <VCombobox clearable density="compact" :disabled="loadingData" v-model="selecOrdergroup" :items="itemsOrdergroup" variant="outlined" label="Ordenar registros" persistent-hint hide-selected hint="" />
        </div>
