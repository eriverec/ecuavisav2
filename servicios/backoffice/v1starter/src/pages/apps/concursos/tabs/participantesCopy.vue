...
function exportExcel() {
  window.location.href = "https://showandevents-service.vercel.app/export/excel?idTrivia=1";
}

function exportCsv() {
  window.location.href = "https://showandevents-service.vercel.app/export/csv?idTrivia=2";
}
        ...
        <VCardItem class="pb-sm-0 ">
          <div class="d-flex justify-space-between">
            ...
            <div>
              ...
              <VBtn variant="tonal" color="primary" prepend-icon="tabler-download" @click="exportCsv">
                CSV
              </VBtn>
