...
<template>
	<section>
        ...
        <VCard>
          ...
          <VCardItem class="py-0 pb-4">
            <VRow>
              ...
              <VCol cols="12" md="8" lg="3" class="d-none">
                <div class="w-100 mt-4">
      ...
      <VCol cols="12" md="12" lg="12">
        <plantilla_articulos_estilo_principal_ia :articulos="filteredData" :filtrosActivos="filtrosActivos" @click:checkSelected="syncSelected" :articulosSelected="articulosSelected" />
      </VCol>
		</VRow>
	</section>
</template>
