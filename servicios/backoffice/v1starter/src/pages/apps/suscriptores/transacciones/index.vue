          ...
          <VTable class="text-no-wrap">
            ...
            <tbody v-if="!loadingTransactions">
              <tr v-for="item in paginatedTransactions" :key="item._id" style="height: 3.75rem;">
                ...
                <td>{{ item.transaction?.payment_date ? moment(item.transaction.payment_date).format('DD-MM-YYYY') : 'N/A' }}
                </td>
                <td>
                ...
                <VListItem>
                  <div class="d-flex justify-space-between align-center">
                    <div >
                      ...
                      <VListItemSubtitle>{{ formatPaymentDate(selectedTransaction.transaction?.payment_date) }}</VListItemSubtitle>
                    </div>
                    <div>
                      <svg style="width: 120px ;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"> <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" /></svg>
  
                    </div>

                  </div>
                </VListItem>
                <div height="1" class="mt-3 mb-3" style="border:0;border-collapse:collapse;margin:0;padding:0;height:1px;font-size:1px;background-color:rgb(235 235 235 / 20%);line-height:1px">&nbsp;</div>
                <VListItem>
                  <div class="d-flex justify-space-between align-center">
                ...
                <div v-if="selectedTransaction.user">
                  <VListItem>
                    <div class="d-flex justify-space-between align-center">
                      ...
                      <VListItemSubtitle> {{ selectedTransaction.user?.first_name }}  {{ selectedTransaction.user?.last_name }}</VListItemSubtitle>
