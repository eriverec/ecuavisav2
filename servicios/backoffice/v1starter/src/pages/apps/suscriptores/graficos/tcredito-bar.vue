	...
	<div v-else>
		<VCardTitle class="pt-4 pl-6">
			...
			<VRow>
				...
				<VCol cols="8" class="d-flex gap-2">
					<VSelect style="width:100%;" v-model="selectedPlan" :items="planes" label="Plan" @update:modelValue="resolveDataRaw" />
					<VSelect style="width:100%;" v-model="selectedTarjeta" :items="tarjetas" label="Tarjeta de Crédito" @update:modelValue="resolveDataRaw" />
					<VSelect style="width:100%;" v-model="selectedRecursivo" :items="recursivo" label="Recursivo" @update:modelValue="resolveDataRaw" />
				</VCol>
			</VRow>
