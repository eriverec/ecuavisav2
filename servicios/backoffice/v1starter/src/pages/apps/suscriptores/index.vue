		...
		<VRow>
			<VCol cols="12">
				<div class="tab-titles parentTabs">
					<div class="" @click="selectTab(0)" :class="{ active: selectedTab === 0 }">
						<VIcon :size="35" icon="tabler-credit-card" />
						<span>Cobros con Tarjeta de crédito</span>
					</div>
					<div @click="selectTab(1)" :class="{ active: selectedTab === 1 }">
						<VIcon :size="35" icon="tabler-box" />
						<span>Cobros por paquete</span>
					</div>
					<div @click="selectTab(2)" :class="{ active: selectedTab === 2 }">
						<VIcon :size="35" icon="tabler-user-plus" />
						<span>Alta de suscriptores</span>
					</div>
					<div @click="selectTab(3)" :class="{ active: selectedTab === 3 }">
						<VIcon :size="35" icon="tabler-user-minus" />
						<span>Baja de suscriptores por paquete</span>
					</div>
					<div @click="selectTab(4)" :class="{ active: selectedTab === 4 }">
						<VIcon :size="35" icon="tabler-user-question" />
						<span>Baja de suscriptores por motivo</span>
					</div>
...
.tab-slider {
	...
	/* Color del slider */
	width: 0;
	/* Inicialmente el ancho es cero */
	transition: width 0.3s;
	/* Agregar transición para suavizar el deslizamiento */
}
