...
const apiUrl = 'https://showandevents-service.vercel.app/all?fechai=2023-01-01&fechaf=2024-10-30&idProyecto=2&idTrivia=1' // Aquí deberás poner la URL de tu API
const data = reactive([])
...
<template>
  ...
  <VCard v-else class="mt-6">
    <div v-for="(group, id) in groupedData" :key="id">
  ...
  <VExpansionPanels multiple class="mt-6" >
