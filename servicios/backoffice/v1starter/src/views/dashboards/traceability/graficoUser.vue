<script setup>
import ChartGraficoUser from "@/views/charts/apex-chart/ChartGraficoUser.vue";
</script>
    ...
    <VCol cols="12">
      <VCard>
        <VCardText class=" flex-wrap justify-space-between gap-4">
          <VCardItem class="pt-0 pb-0 pl-0">
            <VCardTitle>Visitas por usuario</VCardTitle>
            <!-- <VCardSubtitle>Categoría de dispositivos de los últimos 7 días</VCardSubtitle> -->
          </VCardItem>
          <!-- <VDivider /> -->
          
          <ChartGraficoUser @activityData="getActivity" /> 
