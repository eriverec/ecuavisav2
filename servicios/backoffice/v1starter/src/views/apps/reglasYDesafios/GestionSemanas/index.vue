            ...
            <VCol cols="12" sm="12" lg="12">
                    ...
                    <VCardItem style="margin-bottom: -2rem;">
                        <div class="d-flex flex-wrap gap-4">
                            <VBtn prepend-icon="tabler-plus" color="success" variant="tonal" class="ml-auto"
                                @click="onAdd">
                                Nueva semana
                            </VBtn>
                        </div>
            ...
            <VCard class="pa-sm-14 pa-5">
                <VCardItem class="text-center">
                    <VCardTitle class="text-h5 mb-3">
                        {{ accionForm === "add" || accionForm === "duplicate" ? "Nueva semana" : "Editar " +
                        tituloSelected }}
                    </VCardTitle>
                </VCardItem>
                            ...
                            <VRow>
                                ...
                                <VCol cols="12">
                                    ...
                                    <div class="switch-estatus" style="margin-bottom:-10px">
                                        <VSwitch :disabled="switchOnDisabled"
                                            :loading="switchOnDisabled ? 'warning' : false" color="success"
                                            v-model="repechajeModel" size="x-small" class="custom-vswitch"
                                ...
                                <VCol cols="12">
                                    <VTextField v-model="descripcion" label="Descripción"
                                        placeholder="Descripción de la trivia" />
                                </VCol>

                                <VCol cols="12">
                                    <VTextField v-model="imagen_descriptiva" label="Imágen descriptiva"
                                        placeholder="Imágen descriptiva" />
                                </VCol>

                                <VCol cols="12">
                                    <VTextField v-model="urlPremio" label="Link del premio para la semana"
                                        placeholder="Link del premio para la semana" />
                                </VCol>
                                <VCol cols="12">
                                    ...
                                    <div class="date-picker-wrapper" style="width: 100%;">
                                        <AppDateTimePicker prepend-inner-icon="tabler-calendar" density="compact"
                                            v-model="fechaDisplay" show-current=true @on-change="obtenerFechas" :config="{
                                                position: 'auto right',
                                                mode: 'range',
                                                altFormat: 'F j, Y',
                                                dateFormat: 'd-m-Y',
                                                    ...
                                                    <v-list-item-subtitle>
                                                        <div class="d-flex">
                                                            <VCheckbox v-if="desafios.includes(item.value)"
                                                                :model-value="disabledCheckbox = true" readonly />
                                                            <VCheckbox v-else :model-value="disabledCheckbox = false"
                                                                readonly />
