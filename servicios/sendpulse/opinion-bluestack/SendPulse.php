...
class SendPulse {
	...
	function __construct(){
		...
		$this->ctrFunciones = new Ctrfunciones(array(
			"desfaseMinutosMax" => 5,
			"folder" => "opinion-bluestack", // Guardado de img y json
		...
		$this->apiProtec = "https://micuenta.ecuavisa.com/servicio-php-newsletter-cms-react/newsletter/get.php?newsletter=boletin-diario-5pm";
	...
	private function logToFile($data = array()) {
		...
		return $this->log->add([
			...
			"file"=> "boletin-opinion.json",
			"campaign"=>"Boletín Opinión",
