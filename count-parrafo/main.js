function pubCenter1() {
  ...
  rel_center1 =
    "<div align='center' data-ad='top-generico' id='center1' ><script type='text/javascript'>googletag.cmd.push(function() { googletag.display('center1'); });console.log('center1');</script></div>";
